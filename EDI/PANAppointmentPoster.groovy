...
public class  PANAppointmentPoster extends BaseUnitEdiPosterPea implements EdiPoster {
  ...
  private UnitFacilityVisit preadviseContainer(EdiPostingContext inEdiPostingContext,
	...
	try {
	  ...
	  rejectHazardNotAsAdvised(inEdiPostingContext, inEdiAppointment.getEdiHazardArray(), unit);
...
*/
   ...
   * @param inUnit
   */
  private void rejectHazardNotAsAdvised(EdiPostingContext inEdiContext, EdiHazard[] inEdiHazardArray, Unit inUnit) {
